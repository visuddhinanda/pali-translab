...
knowledge:
  ...
  - grammar/absolutive
output: translations/{method}/{book}/{para}_v{n}.jsonl
---
...
逐句 diff `translations/{method}/{book}/{para}_final.jsonl` 与 `gold/{book}/{para}.jsonl`，对每处差异分析：
